								...
								<div class="card">
									<div class="card-header">
										<div class="card-head-row">
											<div class="card-title">Resident Certificate Issurance</div>
										</div>
									</div>
									<div class="card-body">
																		...
																		<div class="form-button-action">
																			<?php if ($template_preference == 'standard' || $template_preference == 'both'): ?>
																				<a type="button" data-toggle="tooltip"
																					href="generate_brgy_cert.php?id=<?= $row["id"] ?>" class="btn btn-link btn-primary"
																					data-original-title="Generate Standard Certificate">
